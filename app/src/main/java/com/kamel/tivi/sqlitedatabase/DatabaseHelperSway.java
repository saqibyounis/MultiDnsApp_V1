...
public class DatabaseHelperSway extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "swaydatabase";
    ...
    public DatabaseHelperSway(Context context) {
